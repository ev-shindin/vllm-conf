...
def rebuild_fp8_moe_kernel(
    ...
    how they derive the two keys. Used by P/D role switching after the
    all2all backend has changed, which changes the activation format and
    therefore the experts class.
